  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text("Voice Calls",style: TextStyle(
        ...
        if (callHistoryController.voiceCallHistoryList.isEmpty) {
          return  Center(
            child: Column(
              ...
              children: [
                const Text("No voice call history found"),
                IconButton(
                  onPressed: () async {
                    await callHistoryController.refreshHistory('voice');
                  },
            ...
            child: Padding(
              ...
              child: ListView.builder(
                ...
                itemBuilder: (context, index) {
                  if (index ==
                      callHistoryController.voiceCallHistoryList.length) {
                  ...
                  final CallHistory call =
                      callHistoryController.voiceCallHistoryList[index];
                  ...
                  return ListTile(
                      ...
                      title: Text(
                        call.isGroupCall ? call.groupName ?? 'Group Call' :
                        name,
