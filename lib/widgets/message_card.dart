...
class MessageCard extends StatelessWidget {
  ...
  const MessageCard({super.key, required this.text, required this.isMe, required this.time, required this.imageUrl, required this.name});
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        Row(
          children: [
            ProfileAvatar(imageUrl: imageUrl, radius: 10),
            SizedBox(width: 5,),
